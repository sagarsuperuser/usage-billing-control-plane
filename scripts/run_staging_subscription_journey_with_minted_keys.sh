...
PLATFORM_KEY_NAME="${PLATFORM_KEY_NAME:-staging-subscription-journey-platform-admin}"
WRITER_KEY_NAME="${WRITER_KEY_NAME:-staging-subscription-journey-writer}"
READER_KEY_NAME="${READER_KEY_NAME:-staging-subscription-journey-reader}"
...
(
  ...
  TARGET_TENANT_ID="$TARGET_TENANT_ID" \
  bash ./scripts/verify_staging_subscription_journey.sh
)
