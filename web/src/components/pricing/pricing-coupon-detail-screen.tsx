      ...
      <main className="mx-auto flex max-w-4xl flex-col gap-5 px-4 py-6 md:px-6 lg:px-8">
        ...
        {isTenantSession ? couponQuery.isLoading ? (
          ...
          <section className="rounded-lg border border-stone-200 bg-white p-5 shadow-sm">
            ...
            <Link to="/pricing/coupons" className="mt-4 inline-flex h-8 items-center gap-1.5 rounded-md border border-stone-200 bg-white px-3 text-xs font-medium text-slate-700 transition hover:bg-slate-50">
            ...
            <div className="rounded-lg border border-stone-200 bg-white shadow-sm divide-y divide-slate-200">
              ...
              <div className="px-5 py-4">
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <Link to="/pricing/coupons" className="inline-flex h-8 items-center gap-1.5 rounded-md border border-stone-200 bg-white px-3 text-xs font-medium text-slate-700 transition hover:bg-slate-50">
                    <ArrowLeft className="h-3.5 w-3.5" />
                    Back to coupons
                  </Link>
                </div>
