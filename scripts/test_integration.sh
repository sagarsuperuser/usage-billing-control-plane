...
integration_test_pattern="${INTEGRATION_TEST_PATTERN:-TestEndToEndPreviewReplayReconciliation|TestRatingRuleGovernanceLifecycle|TestAPIKeyLifecycleEndpoints|TestAuditExportToS3}"
