...
PLATFORM_KEY_NAME="${PLATFORM_KEY_NAME:-staging-payment-smoke-platform-admin}"
WRITER_KEY_NAME="${WRITER_KEY_NAME:-staging-payment-smoke-writer}"
READER_KEY_NAME="${READER_KEY_NAME:-staging-payment-smoke-reader}"
