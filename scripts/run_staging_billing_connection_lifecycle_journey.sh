...
(
  ...
  PLAYWRIGHT_LIVE_BASE_URL="$PLAYWRIGHT_LIVE_BASE_URL" \
  PLAYWRIGHT_LIVE_API_BASE_URL="$PLAYWRIGHT_LIVE_API_BASE_URL" \
  PLAYWRIGHT_LIVE_PLATFORM_ADMIN_EMAIL="$PLAYWRIGHT_LIVE_PLATFORM_ADMIN_EMAIL" \
  PLAYWRIGHT_LIVE_PLATFORM_ADMIN_PASSWORD="$PLAYWRIGHT_LIVE_PLATFORM_ADMIN_PASSWORD" \
