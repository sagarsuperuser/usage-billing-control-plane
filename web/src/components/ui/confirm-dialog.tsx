  ...
  return (
    <>
      ...
      {isOpen ? (
        ...
        >
          <div className="w-full max-w-sm rounded-lg bg-surface shadow-xl ring-1 ring-black/10">
            <div className="p-5">
            ...
            <div className="flex justify-end gap-2 border-t border-border-light px-5 py-3">
              <button
                ...
                disabled={isPending}
                className="inline-flex h-8 items-center rounded-md border border-border px-3 text-xs font-medium text-text-secondary transition hover:bg-surface-secondary disabled:opacity-50"
              >
                {cancelLabel}
              </button>
              <button
