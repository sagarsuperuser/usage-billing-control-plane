...
PLATFORM_KEY_NAME="${PLATFORM_KEY_NAME:-staging-issued-invoice-journey-platform-admin}"
WRITER_KEY_NAME="${WRITER_KEY_NAME:-staging-issued-invoice-journey-writer}"
READER_KEY_NAME="${READER_KEY_NAME:-staging-issued-invoice-journey-reader}"
